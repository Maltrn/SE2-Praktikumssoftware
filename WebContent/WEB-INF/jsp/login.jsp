...
<body>
  <div class="container">
    <br>
    <div class="row">
      <div class="col-sm-7 col-lg-offset-2 text-center">
        <div class="panel panel-default">
          <div class="panel-body">
            <h1 class="text-muted">SE2-Praktikumssoftware</h1>
            <br>
            <form class="form-signin col-sm-6 col-lg-offset-3 text-center">
              ...
              <p><button class="btn btn-md btn-primary btn-block " type="submit">Anmelden</button></p>
              <br>
            </form>
            <div class="panel panel-primary col-sm-10 col-lg-offset-1">
                <div class="panel-body text-left">
                  <h2 class="text-left text-muted"><strong>News</strong></h2>
                   Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod
                   invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero
                   eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no
                   sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet
                   <br>
                   <h4 class="text-left text-muted"><strong>Header 2</strong></h4>
