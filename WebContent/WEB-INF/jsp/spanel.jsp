  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-sm-12">
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-my-default" ng-click="">News</button>
          </div>
          <div class="btn-group">
            <button type="button" class="btn btn-my-default" ng-click="">Profil</button>
          </div>
          <div class="btn-group">
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-my-default dropdown-toggle" data-toggle="dropdown">
              ...
              <ul class="dropdown-menu" role="menu">
                <li><a href="" ng-click=""><span class="text text-success">Pflichtpraktika</span></a></li>
                <li><a href="" ng-click=""><span class="text text-danger">Wahlpflicht</span></a></li>
                <li><a href="" ng-click=""><span class="text text-danger">Projekt</span></a></li>
              </ul>
          </div>
          <div class="btn-group">
            <button type="button" class="btn btn-my-default dropdown-toggle" data-toggle="dropdown">
              Abmelden <span class="caret"></span></button>
              <ul class="dropdown-menu" role="menu">
                <li><a href="" ng-click=""><span class="text text-success">Pflichtpraktika</span></a></li>
                <li><a href="" ng-click=""><span class="text text-danger">Wahlpflicht</span></a></li>
                <li><a href="" ng-click=""><span class="text text-danger">Projekt</span></a></li>
          ...
          <div class="btn-group">
            <button type="button" class="btn btn-my-default" ng-click="">Leistungen</button>
          </div>
          <div class="btn-group">
            <button type="button" class="btn btn-my-default" ng-click="">Meldungen <span class="badge">2</span></button>
          </div>
          <div class="btn-group">
