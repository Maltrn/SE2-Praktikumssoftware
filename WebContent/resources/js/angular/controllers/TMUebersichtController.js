...
(function () {
  ...
  var app = angular.module("SE2-Software");
	...
	var TMUebersichtController = function($scope, autoscroller /*, $http*/){
    ...
    $scope.teilnehmer = [{matrNr: 243441, vorn: "Max", nachn: "Mustermann1", tmNr: 1, tmPartner: "Max Mustermann3", pvl: "erfolgreich", note: 15},
                         {matrNr: 243442, vorn: "Max", nachn: "Mustermann2", tmNr: 4, tmPartner: "Max Mustermann4", pvl: "nicht erfolgreich", note: -1},
                         {matrNr: 243443, vorn: "Max", nachn: "Mustermann3", tmNr: 1, tmPartner: "Max Mustermann1", pvl: "erfolgreich", note: 3},
                         {matrNr: 243444, vorn: "Max", nachn: "Mustermann4", tmNr: 4, tmPartner: "Max Mustermann2", pvl: "nicht erfolgreich", note: -1},
                         {matrNr: 243445, vorn: "Max", nachn: "Mustermann5", tmNr: 5, tmPartner: "Max Mustermann6", pvl: "offen", note: -1},
                         {matrNr: 243446, vorn: "Max", nachn: "Mustermann6", tmNr: 5, tmPartner: "Max Mustermann5", pvl: "offen", note: -1}]
